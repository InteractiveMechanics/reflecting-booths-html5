...
class Progress extends Component {
  constructor(props) {
    super(props);
    this.state = { currentState: props.currentState};
  }
...
//
  return (
      <ul className="progressbar">
          <li className={homeStyle}><h3>Home</h3>
          ...
          <li className={aboutStyle}><h3>About</h3>
          ...
          <li className={questionsStyle}><h3>Questions</h3>
          ...
          <li className={recordStyle}><h3>Record</h3>
          ...
          <li className={submitStyle}><h3>Submit</h3>
